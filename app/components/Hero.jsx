...
const Hero1 = () => {
    return (
        ...
        >
            <div className='mt-10 mx-auto max-w-lg p-2 px-4 text-center sm:max-w-xl md:max-w-2xl lg:max-w-4xl'>
